...
//               Discover delicious recipes and culinary inspiration for every occasion. Join our community of food lovers
//               and share your passion for cooking.
//             </p>
//           </div>
...
//               </li>
//               <li>
//                 <a href="/blogs" className="text-gray-300 hover:text-green-400 transition-colors duration-200">
//                   Blog
//                 </a>
//               </li>
//             </ul>
...
//           <p>&copy; {new Date().getFullYear()} FoodBlog. All rights reserved.</p>
//         </div>
//       </div>
//     </footer>
//   )
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="/blogs" className="text-gray-300 hover:text-green-400">Blog</a></li>
              </ul>
            </div>
